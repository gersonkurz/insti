...
// =============================================================================
// insti/core/project.h - Project blueprint (standalone .xml)
// =============================================================================
...
class Project : public Blueprint
{
public:
    /// Load project blueprint from an XML file.
    /// @param xml_path Path to the .xml blueprint file
    /// @return Project pointer on success (caller owns ref), nullptr on failure
    static Project* load_from_file(std::string_view xml_path);
    ...
    /// @return Project pointer on success (caller owns ref), nullptr on failure
    static Project* load_from_string(std::string_view xml, std::string_view source_path);
